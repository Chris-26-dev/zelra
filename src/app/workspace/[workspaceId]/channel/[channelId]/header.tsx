                    ...
                    <div className="px-4 pb-4 flex flex-col gap-y-2">
                            ...
                            <DialogContent>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    <Input
                                        ...
                                        minLength={3}
                                        maxLength={80}
                                        placeholder="e.g travel-to-korea"
                                    />
                                    <DialogFooter>
                                        <DialogClose asChild>
                        ...
                        {member?.role === "admin" && (
                            <button
                                ...
                                className="flex items-center gap-x-2 px-5 py-4 bg-white rounded-lg cursor-pointer border hover:bg-gray-50 text-amber-700">
